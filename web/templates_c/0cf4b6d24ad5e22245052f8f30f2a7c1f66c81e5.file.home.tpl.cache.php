<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-30 11:53:19
         compiled from ".\templates\home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207175512ff8ebc1120-22635207%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0cf4b6d24ad5e22245052f8f30f2a7c1f66c81e5' => 
    array (
      0 => '.\\templates\\home.tpl',
      1 => 1427709196,
      2 => 'file',
  ...
  'nocache_hash' => '207175512ff8ebc1120-22635207',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5512ff8ec0f5c0_54537995',
  'variables' => 
  array (
    'username' => 0,
    'role' => 0,
...
<?php if ($_valid && !is_callable('content_5512ff8ec0f5c0_54537995')) {function content_5512ff8ec0f5c0_54537995($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"><?php echo $_smarty_tpl->tpl_vars['username']->value;?>
</a>
                 <a class="navbar-brand page-scroll" href="#page-top"><?php echo $_smarty_tpl->tpl_vars['role']->value;?>
</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#agents">Agents</a>
                    </li>
                    <li>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="img/sharath.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>Sharath</h4>
                                    <h4 class="subheading">Feather tourism</h4>
                                </div>
                                <div class="timeline-body">
                                    <!--<p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente, totam reiciendis temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo dolore laudantium consectetur!</p>-->
                                    <a href="agentdisp.php?name=sharath">Click for more info about the agent</a>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="img/shashaank.jpg" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>Shashaank</h4>
                                    <h4 class="subheading">India Tourism</h4>
                                </div>
                                <div class="timeline-body">
                                     <a href="agentdisp.php?name=shashaank">Click for more info about the agent</a>
                                </div>
                            </div>
                        </li>
                    </ul>
...
>
    ...
    <!-- Plugin JavaScript -->
    <?php echo '<script'; ?>
 src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="js/classie.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="js/cbpAnimatedHeader.js"><?php echo '</script'; ?>
>
...
>
    ...
    <?php echo '<script'; ?>
 src="js/agency.js"><?php echo '</script'; ?>
>
